    ...
    return (
        <div>
            ...
            <div className="dietcalendar">
                <div className='dietcalendar-box'>
                <div className='dietcalendar-text'>식단생성 게시판</div>
                <button className="dietcalendar-add" onClick={handleOpenModel}>식단추가</button>
                    {modelOpen && (
                        <div className="model">
                            <div className="model-content">
                            <button className='model-close' onClick={handleCloseModal}>X</button>
                            <div className='model-text1'>식단을 생성할 월을 선택해주세요</div>
                            <DatePicker selected={selectedDate} onChange={handleDateChange} dateFormat="yyyy/MM" showMonthYearPicker />
                            <button className='model-text2' onClick={handleGoToCalendar}>확인</button>
                            </div>
                        </div>
                    )}
                </div>
